...
2. Don't use memoization for every single function inside the component because it will create unnecessary memory (because you have to store the returned cache in a new variable)
